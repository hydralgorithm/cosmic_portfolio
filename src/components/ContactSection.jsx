                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6 justify-center">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:hydralgorithm@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                                        hydralgorithm@gmail.com
                                    </a>
                                </div>
                            </div>
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+919035198833" className="text-muted-foreground hover:text-primary transition-colors">
                                        +91 903-519-8833
                                    </a>
                                </div>
                            </div>
                        ...
                        <div className="pt-8">
                            ...
                            <div className="flex space-x-4 justify-center">
                                ...
                                <a href="https://www.instagram.com/fattaahh._/" target="_blank">
                                    <Instagram />
                                </a>
                                <a href="https://discordapp.com/users/765056884423262229" target="_blank">
                                    <FaDiscord size={24} />
                                </a>
                            </div>
                        </div>
